...
this["ShiftTracker"]["templates"]["shift"]["summary"] = Handlebars.template({"compiler":[7,">= 4.0.0"],"main":function(container,depth0,helpers,partials,data) {
    var helper;

  return "<div class=\"add-wrap\">\n    <div class=\"content\">\n        content\n    </div>\n</div>\n\n"
    + container.escapeExpression(((helper = (helper = helpers.debug || (depth0 != null ? depth0.debug : depth0)) != null ? helper : helpers.helperMissing),(typeof helper === "function" ? helper.call(depth0 != null ? depth0 : (container.nullContext || {}),{"name":"debug","hash":{},"data":data}) : helper)));
},"useData":true});
