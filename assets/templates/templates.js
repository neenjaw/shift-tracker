...
Handlebars.registerPartial("shift_entry_modal_content", Handlebars.template({"1":function(container,depth0,helpers,partials,data) {
  ...
  return "                <li class=\"shift-mod-item\" data-shift-mod-id=\""
  ...
  return "<div class=\"shift-entry-modal__wrapper\">\r\n    <input id=\"shift-details-shift-id\" type=\"hidden\" name=\"shift-id\" value=\""
    + alias2(alias1((depth0 != null ? depth0.id : depth0), depth0))
    ...
    + "</span>\r\n                <a class=\"show-shift-item-edit btn btn-sm btn-secondary\" href=\"javascript:void(0);\">\r\n                    <i class=\"fas fa-pencil-alt\"></i>\r\n                </a>\r\n            </span>\r\n            <span class=\"hidden\">\r\n                <!-- Hidden input to edit role -->\r\n                <form class=\"shift-item-edit\">\r\n                    <select class=\"role-select\" required>\r\n"
    ...
    + "                    </select>\r\n\r\n                    <button class=\"cancel-shift-item-edit btn btn-sm btn-secondary\">\r\n                        <i class=\"fas fa-times\"></i>\r\n                    </button>\r\n                    <button class=\"submit-shift-item-edit btn btn-sm btn-success\">\r\n                        <i class=\"fas fa-check\"></i>\r\n                    </button>\r\n                </form>\r\n            </span>\r\n        </li>\r\n\r\n        <li class=\"list-group-item\">\r\n            <span>Assignment:\r\n                <span class=\"assignment-name\">"
    ...
    + "            </ul>\r\n            <form class=\"shift-mod-add\">\r\n                <select class=\"shift-mods\">\r\n"
    + ((stack1 = helpers.each.call(alias3,(depth0 != null ? depth0.mods : depth0),{"name":"each","hash":{},"fn":container.program(5, data, 0),"inverse":container.noop,"data":data})) != null ? stack1 : "")
...
Handlebars.registerPartial("shift_entry_modal_footer", Handlebars.template({"compiler":[7,">= 4.0.0"],"main":function(container,depth0,helpers,partials,data) {
    return "<button class='shift-entry-delete btn btn-danger'>Delete</button>";
},"useData":true}));
