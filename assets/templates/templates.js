...
Handlebars.registerPartial("add_shift_assignment", Handlebars.template({"compiler":[7,">= 4.0.0"],"main":function(container,depth0,helpers,partials,data) {
    return "assignment";
},"useData":true}));
...
Handlebars.registerPartial("add_shift_controls", Handlebars.template({"compiler":[7,">= 4.0.0"],"main":function(container,depth0,helpers,partials,data) {
    return "<button class=\"btn btn-primary\">Previous</a>\r\n<button class=\"btn btn-primary ml-2\">Next</a>\r\n<button class=\"btn btn-primary ml-2\">Submit</a>";
},"useData":true}));
...
Handlebars.registerPartial("add_shift_mod", Handlebars.template({"compiler":[7,">= 4.0.0"],"main":function(container,depth0,helpers,partials,data) {
    return "mod";
},"useData":true}));
...
Handlebars.registerPartial("add_shift_role", Handlebars.template({"compiler":[7,">= 4.0.0"],"main":function(container,depth0,helpers,partials,data) {
    return "role";
},"useData":true}));
...
Handlebars.registerPartial("add_shift_staff", Handlebars.template({"compiler":[7,">= 4.0.0"],"main":function(container,depth0,helpers,partials,data) {
    return "staff";
},"useData":true}));
