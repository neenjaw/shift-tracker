...
<?php require('../partials/02-head-prestyle.php'); ?>
    <link rel="stylesheet" type="text/css" media="screen" href="/assets/css/admin.css<?php echoGetQueryWithDate(); ?>" />
...
<?php require('../partials/06-prescript.php'); ?>
    ...
    <script src="/assets/js/admin.js<?php echoGetQueryWithDate(); ?>"></script>
