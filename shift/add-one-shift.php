...
<?php require('../partials/02-head-prestyle.php'); ?>
    <link rel="stylesheet" type="text/css" media="screen" href="/assets/css/add-one-shift.css<? echoGetQueryWithDate(); ?>" />
...
<?php require('../partials/06-prescript.php'); ?>
    ...
    <script src="/assets/js/add-one-shift.js<? echoGetQueryWithDate(); ?>"></script>
